...
String message="";
if(title != null && type != null && type2 != null && description != null && date != null && season != null && picture != null)
{
database.connectDB();
database.insertData(title,type,type2,description,date,season,picture);
message="新增成功!";
}else{
message="新增失敗";
}
